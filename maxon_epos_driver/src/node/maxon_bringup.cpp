...
#include <vector>
#include <string>
#include "../../include/maxon_epos_driver/EposManager.hpp"
...
int main(int argc, char** argv)
{
    ...
    if (!private_nh.getParam("motor_names", motor_names)) {
        RCLCPP_FATAL("Failed to load motor_names");
        return 1;
    }
    ...
    {
        RCLCPP_FATAL("Failed to initialize EposManager");
        return 1;
    }
    RCLCPP_INFO("Motors Initialized");
